...
function MovieTabContent({
  ...
  const isAiMode = pathname.includes('/ai-mode');
    ...
    <section className="bg-gray-50 py-16 dark:bg-gray-900">
      <div className="container mx-auto px-4">
        ...
        <Tabs defaultValue="now-showing" className="w-full">
          <TabsList className="mb-8 grid w-full max-w-md grid-cols-2 rounded-xl bg-gray-200 p-1 dark:bg-gray-700">
            <TabsTrigger
              value="now-showing"
              className="flex items-center gap-2 rounded-lg font-semibold transition-all data-[state=active]:bg-gradient-to-r data-[state=active]:from-orange-500 data-[state=active]:to-orange-600 data-[state=active]:text-white"
            ...
            <TabsTrigger
              value="coming-soon"
              className="flex items-center gap-2 rounded-lg font-semibold transition-all data-[state=active]:bg-gradient-to-r data-[state=active]:from-blue-500 data-[state=active]:to-blue-600 data-[state=active]:text-white"
