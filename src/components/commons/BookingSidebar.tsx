...
import { Ticket, Sparkles, Bot, Film, Popcorn } from 'lucide-react';
...
export function BookingSidebar() {
  return (
    ...
    >
        ...
        <div className="bg-gradient-to-r from-orange-500 to-orange-600 px-5 py-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-orange-100">Trợ lý thông minh đặt vé</p>
            </div>
          </div>
        </div>
      </SidebarHeader>
      ...
      <SidebarContent>
        <SidebarGroup>
          <SidebarGroupLabel className="text-xs font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-400">
            Đặt vé nhanh
          </SidebarGroupLabel>
          <SidebarGroupContent>
            <div className="flex flex-col items-center justify-center px-4 py-10 text-center">
              ...
              <p className="mb-6 text-sm leading-relaxed text-gray-500 dark:text-gray-400">
                Tính năng đang được phát triển. Bạn có thể xem phim đang chiếu tại trang chủ và đặt
                vé trực tiếp.
              </p>

              <div className="w-full space-y-3">
                <Link href="/" className="block">
                  <Button className="w-full bg-gradient-to-r from-orange-500 to-orange-600 text-white shadow-lg shadow-orange-500/25 transition-all duration-300 hover:from-orange-600 hover:to-orange-700">
